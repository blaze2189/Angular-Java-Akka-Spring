...
import com.blaze.actor.service.UserServiceActor;
...
public class SpringUserController {
	...
	private Logger log = Logger.getLogger(SpringUserController.class);
	...
	protected Future<User> futureUser(Future<Object> futureObject) {
		return futureObject.map(new Mapper<Object, User>() {
			@Override
